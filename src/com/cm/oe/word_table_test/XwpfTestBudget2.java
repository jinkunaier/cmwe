...
import com.cm.oe.test.UpdateBudget2;

public class XwpfTestBudget2 {
	...
	private UpdateBudget2 ub = new UpdateBudget2(path1, path2);
	/**
...
//			setRowCellText(tableOneRowTwo.getCell(i), values, 3, true, 3,"BFBFBF", STVerticalJc.CENTER, STJc.LEFT);
			i++;
		}
		doc.write(os);
		os.flush();
	...
	public static void main(String[] args) {
		try {
			XwpfTestBudget2 xwpf = new XwpfTestBudget2();
			xwpf.testReadByDoc();
		} catch (Exception e) {
